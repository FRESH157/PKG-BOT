       ...
       case 'igstalk':
           igStalk(value)
               .then(data => {
                   ...
                   client.sendMessage(id, '[ESPERE] Stalking...⏄1�71ￄ1�77', MessageType.text)
      ...
      case 'stickergif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    ...
                    client.reply(from, '[WAIT] Sendo processado⏄1�71ￄ1�77 Por favor, espere ± 1 min!', id)
